...
const Module* CodeGenerator::getModule() const { return module_; }

llvm::IRBuilder<>* CodeGenerator::getBuilder() const { return builder_; }

FunctionPassManager* CodeGenerator::getFunctionPassManager() const {
  return fpm_;
}

ExecutionEngine* CodeGenerator::getExecutionEngine() const { return engine_; }

void CodeGenerator::lock() { lock_.acquire(); }
