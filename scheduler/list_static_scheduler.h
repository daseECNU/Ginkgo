...
#ifndef SCHEDULER_LIST_STATIC_SCHEDULER_H_
#define SCHEDULER_LIST_STATIC_SCHEDULER_H_
...
class ListStaticScheduler : public BackfillScheduler {
 public:
  ListStaticScheduler(PipelineJob* const dag_root, StmtExecStatus* exec_status);
  PipelineJob* GetPivotJob();
  bool CouldSchedule(PipelineJob* pjob);
  virtual ~ListStaticScheduler();
...
#endif  //  SCHEDULER_LIST_STATIC_SCHEDULER_H_
