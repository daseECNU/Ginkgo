...
#ifndef SCHEDULER_LIST_PREEMPTION_SCHEDULER_H_
#define SCHEDULER_LIST_PREEMPTION_SCHEDULER_H_
...
class ListPreemptionScheduler : public BackfillScheduler {
 public:
  ListPreemptionScheduler(PipelineJob* const dag_root,
  ...
  virtual ~ListPreemptionScheduler();
...
#endif  //  SCHEDULER_LIST_PREEMPTION_SCHEDULER_H_
