...
ListPreemptionScheduler::ListPreemptionScheduler(
...
void ListPreemptionScheduler::ScheduleJob(caf::event_based_actor* self,
                                          ListPreemptionScheduler* scheduler) {
  LOG(INFO) << "ListPreemption starts up now!";
...
PipelineJob* ListPreemptionScheduler::GetPivotJob() { return NULL; }

bool ListPreemptionScheduler::IsConflict(
...
void ListPreemptionScheduler::CreateActor() {
