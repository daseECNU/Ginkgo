...
#ifndef SCHEDULER_LIST_FILLING_SCHEDULER_H_
#define SCHEDULER_LIST_FILLING_SCHEDULER_H_
...
class ListFillingScheduler : public BackfillScheduler {
 public:
  ListFillingScheduler(PipelineJob* const dag_root,
                             StmtExecStatus* exec_status);
  PipelineJob* GetPivotJob();
  bool CouldSchedule(PipelineJob* pjob);
  virtual ~ListFillingScheduler();
...
#endif  //  SCHEDULER_LIST_FILLING_SCHEDULER_H_
