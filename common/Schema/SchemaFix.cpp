 ...
 *
 * TODO(ANYONE): check from the second column, because the first column is
 *  always row_id, which is generated by claims and is always valid. So
 *  AddRowId() should be called after this method---YuKai
 */
