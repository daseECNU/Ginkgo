...
'''
sql_data_case=(
		#	("/home/claims/data/tpc-h/sf1/1partition/", 5, 1, (("table_join3"), ("table_join6"))),
		#	("/home/claims/data/tpc-h/sf1/2partition/", 5, 1, (("table_join3"), ("table_join6"))),
		#	("/home/claims/data/tpc-h/sf1/4partition/", 5, 1, (("table_join3"), ("table_join6"))),
		#	("/home/claims/data/tpc-h/sf1/8partition/", 5, 1, (("table_join3"), ("table_join6"))),
		#	("/home/claims/data/tpc-h/sf10/1partition/", 5, 1, (("table_join3"), ("table_join6"))),
		#	("/home/claims/data/tpc-h/sf10/2partition/", 5, 1, (("table_join3"), ("table_join6"))),
		#	("/home/claims/data/tpc-h/sf10/4partition/", 5, 1, (("table_join3"), ("table_join6"))),
		#	("/home/claims/data/tpc-h/sf10/8partition/", 5, 1, (("table_join3"), ("table_join6"))),
		#	("/home/claims/data/tpc-h/sf100/4partition/", 5, 1, (("table_join3"), ("table_join6"))),
			("/home/claims/data/tpc-h/sf100/8partition/", 5, 1, (("table_join3"), ("table_join6"))),
		)
...
def autotest():
    for i in sql_data_case:
        ...
        command1=config_data%(user, hostname, i[0])+deploy%(user, hostname)
        print command1
        os.system(command1)
        time.sleep(5)
        for j in i[3]:
            ...
            time.sleep(60)
            print "test:[%s],loop:[%d],currencuy:[%d]" % (j, i[1], i[2])
            os.system(runtest % (claimshome, i[1], i[2], j))
            time.sleep(5)
        os.system(stopall%claimshome)
        time.sleep(2)
