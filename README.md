...
**Ginkgo** is an in-memory distributed data management and processing system for big data processing applications, which runs on clusters of commodity servers and aims to provide real-time data analytics on relational dataset. It is derived from [CLAIMS](https://github.com/dase/CLAIMS).

This branch aims at scheduling multiple pipelines with DAG dependency.
